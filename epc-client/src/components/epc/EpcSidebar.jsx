...
const EpcSidebar = ({ collapsed, setCollapsed, darkMode, setDarkMode }) => {
  ...
  return (
    <aside
      className={`${collapsed ? 'w-16' : 'w-60'} transition-all duration-300 bg-gray-900 border-r border-gray-800 flex flex-col h-screen sticky top-0 z-40`}
    >
      {/* Logo */}
      <div className="flex items-center gap-3 px-4 py-5 border-b border-gray-800">
        ...
        <button onClick={() => setCollapsed(!collapsed)}
          className="ml-auto text-gray-600 hover:text-gray-300 flex-shrink-0">
        ...
        {!collapsed ? (
          <div className="flex items-center gap-3">
            ...
            <button onClick={logout}
              className="text-gray-600 hover:text-red-400 flex-shrink-0" title="Logout">
              <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
          ...
          <button onClick={logout}
            className="w-full flex justify-center text-gray-600 hover:text-red-400 py-1">
            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
                d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" />
            </svg>
