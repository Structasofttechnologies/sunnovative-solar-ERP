...

{
  ...
  isExpanded:
    expandedSections.leadManagement,
  ...
  children: [
...

    {
      ...
      isExpanded:
        expandedSections.projectWiseLeads,

      children: [

        {
          name: '- Surya Ghar Yojana',

          href:
            '/admin/leads/project/surya-ghar',
...

        {
          ...
          href:
            '/admin/leads/project/group-solar',

          icon: Users,
        },

        {
          name: '- RWA Society Solar',

          href:
            '/admin/leads/project/rwa-society',
        ...
        {
          name:
            '- Commercial SolarKits',

          href:
            '/admin/leads/project/commercial',
      ...
      children: [
        ...
        },
        {
          ...
          children: [
            ...
            { name: '- Add Project Description', href: '/admin/settings/product/project-description', icon: LayoutDashboard },
