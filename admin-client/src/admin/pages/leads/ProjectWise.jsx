...
const PROJECT_META = {
  'surya-ghar': {
    label: 'Surya Ghar Yojana',
    description: 'PM Surya Ghar Muft Bijli Yojana — Residential rooftop solar leads',
    color: 'bg-orange-50 border-orange-200 text-orange-700',
    emoji: '☀️',
  },
  'group-solar': {
    label: 'Group Solar',
    description: 'Bulk solar installations for groups and communities',
    color: 'bg-blue-50 border-blue-200 text-blue-700',
    emoji: '👥',
  },
  'rwa-society': {
    label: 'RWA Society Solar',
    description: 'Solar for Resident Welfare Associations and housing societies',
    color: 'bg-green-50 border-green-200 text-green-700',
    emoji: '🏢',
  },
  commercial: {
    label: 'Commercial SolarKits',
    description: 'Commercial and industrial solar kit installations',
    color: 'bg-purple-50 border-purple-200 text-purple-700',
    emoji: '🏭',
  },
  village: {
    label: 'Village Campaigns',
    description: 'Solar awareness and installation drives in villages',
    color: 'bg-yellow-50 border-yellow-200 text-yellow-700',
    emoji: '🌾',
  },
  msme: {
    label: 'MSME Solar',
    description: 'Solar solutions for Micro, Small & Medium Enterprises',
...
export default function ProjectWise() {
  ...
  const fetchLeads = async () => {
    setLoading(true);
    try {
      const data = await leadsApi.getLeadsByProject(slug, { limit: 100 });
      setLeads(data.leads || []);
