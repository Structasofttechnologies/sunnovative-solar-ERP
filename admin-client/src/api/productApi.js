...
export const productApi = {
    ...
    // ✅ ADD HERE
getProjectDescriptions: (params) =>
  axiosInstance.get('/project-descriptions', { params }),

createProjectDescription: (data) =>
  axiosInstance.post('/project-descriptions', data),

updateProjectDescription: (id, data) =>
  axiosInstance.put(`/project-descriptions/${id}`, data),

deleteProjectDescription: (id) =>
  axiosInstance.delete(`/project-descriptions/${id}`),
};
