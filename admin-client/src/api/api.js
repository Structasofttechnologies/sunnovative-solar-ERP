...
export const formBuilderAPI = {
  ...
  updateFormFields: (id, fields) => api.put(`/forms/${id}/fields`, { fields }),
  addField: (id, data) => api.post(`/forms/${id}/fields`, data),
  updateField: (id, fieldId, data) => api.put(`/forms/${id}/fields/${fieldId}`, data),
  removeField: (id, fieldId) => api.delete(`/forms/${id}/fields/${fieldId}`),

  // Public – Fetch form schema for rendering
  getPublicForm: (slug) => api.get(`/forms/public/${slug}`),

  // Public – Submit form
  submitForm: (slug, data) => api.post(`/forms/public/${slug}/submit`, data),

  // Admin – Submissions
  getSubmissions: (slug, params) => api.get(`/forms/submissions/${slug}`, { params }),
  updateSubmissionStatus: (submissionId, data) =>
    api.put(`/forms/submissions/${submissionId}/status`, data),
};
