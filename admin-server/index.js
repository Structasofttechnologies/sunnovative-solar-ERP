...
import projectDescriptionRoutes from './routes/projects/projectDescriptionRoutes.js';
...
import formRoutes from './routes/Form/formRoutes.js';
...
if (process.env.DEV_FRONTEND_URL) {
  allowedOrigins.push(process.env.DEV_FRONTEND_URL.trim());
}
...
app.use('/project-description', projectDescriptionRoutes);
